...
public class DataBase {
	...
	public void addIt(String ln, String fn, String id) {
		...
		if(ID.getSize() > 0) {
			...
			System.out.println(idIsAvailable);
		}
		if(idIsAvailable) {
			...
			//System.out.println("creating dbrecord");
			...
			//System.out.println("added to dbrecord");
